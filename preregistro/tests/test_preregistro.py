...
class GetHorarioAtencionListTest(APITestCase):
    def setUp(self):
...
class GetHorarioAtencionDetailTest(APITestCase):
    def setUp(self):
        medico3 = Medico.objects.create(
            id=3, nombre='elianid', apPaterno='tolentino', apMaterno='olvera', rfc='quog??0406', curp='curp1', fechaNac='2020-09-09', pais='pais1', estado='estado1', ciudad='ciudad1',
            deleMuni='deleMuni1', colonia='colonia', calle='calle1', cp='cp1', numExterior='numExterior1', rfcFacturacion='rfcFacturacion1', cedProfesional='cedProfesional1',
    ...
    def test(self):
        ...
        response = self.client.get('/api/preregistro/horario-atencion/3/detail/')
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        response = self.client.get('/api/preregistro/horario-atencion/9/detail/')
        print(f'response JSON ===>>> 404 \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)


class PutHorarioAtencionTest(APITestCase):
    def setUp(self):
        medico3 = Medico.objects.create(
            id=3, nombre='elianid', apPaterno='tolentino', apMaterno='olvera', rfc='quog??0406', curp='curp1', fechaNac='2020-09-09', pais='pais1', estado='estado1', ciudad='ciudad1',
            deleMuni='deleMuni1', colonia='colonia', calle='calle1', cp='cp1', numExterior='numExterior1', rfcFacturacion='rfcFacturacion1', cedProfesional='cedProfesional1',
    ...
    def test(self):
        ...
        response = self.client.put('/api/preregistro/horario-atencion/3/update/', data=json.dumps(self.json), content_type="application/json")
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class PutPreregistroTest(APITestCase):
    def setUp(self):
        Medico.objects.create(id=1, nombre='n1', apPaterno='app1', apMaterno='apm1', rfc='rfc1', curp='curp1', fechaNac='2020-09-09', pais='pais1', estado='estado1', ciudad='ciudad1',
                              deleMuni='deleMuni1', colonia='colonia', calle='calle1', cp='cp1', numExterior='numExterior1', rfcFacturacion='rfcFacturacion1', cedProfesional='cedProfesional1',
                              cedEspecialidad='cedEspecialidad1', cedCirugiaGral='cedCirugiaGral1', hospitalResi='hospitalResi1', telJefEnse='telJefEnse1', fechaInicioResi='1999-06-06',
...
class GetNotasObservacionesListTest(APITestCase):
    def setUp(self):
        ...
        NotasObservaciones.objects.create(medico=medico9, texto='texto X1', isBorrado=False, tipo='Nota')
        NotasObservaciones.objects.create(medico=medico9, texto='texto X2', isBorrado=False, tipo='Observacion')
        NotasObservaciones.objects.create(medico=medico9, texto='texto X3', isBorrado=True, tipo='Nota')
        NotasObservaciones.objects.create(medico=medico3, texto='texto X4', isBorrado=False, tipo='Nota')
        NotasObservaciones.objects.create(medico=medico3, texto='texto X5', isBorrado=False, tipo='Nota')
    ...
    def test(self):
        ...
        response = self.client.get('/api/preregistro/notas-observaciones/list/')
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        response = self.client.get('/api/preregistro/notas-observaciones/list/?medico=9')
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        response = self.client.get('/api/preregistro/notas-observaciones/list/?medico=9&tipo=Nota')
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        response = self.client.get('/api/preregistro/notas-observaciones/list/?medico=9&tipo=Nota&isBorrado=False')
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)


class GetNotasObservacionesDetailTest(APITestCase):
    def setUp(self):
        medico3 = Medico.objects.create(
            id=3, nombre='elianid', apPaterno='tolentino', apMaterno='olvera', rfc='quog??0406', curp='curp1', fechaNac='2020-09-09', pais='pais1', estado='estado1', ciudad='ciudad1',
            deleMuni='deleMuni1', colonia='colonia', calle='calle1', cp='cp1', numExterior='numExterior1', rfcFacturacion='rfcFacturacion1', cedProfesional='cedProfesional1',
    ...
    def test(self):
        ...
        response = self.client.get('/api/preregistro/notas-observaciones/3/detail/')
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        response = self.client.get('/api/preregistro/notas-observaciones/33/detail/')
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)


class PutNotasObservacionesTest(APITestCase):
    def setUp(self):
        medico3 = Medico.objects.create(
            id=3, nombre='elianid', apPaterno='tolentino', apMaterno='olvera', rfc='quog??0406', curp='curp1', fechaNac='2020-09-09', pais='pais1', estado='estado1', ciudad='ciudad1',
            deleMuni='deleMuni1', colonia='colonia', calle='calle1', cp='cp1', numExterior='numExterior1', rfcFacturacion='rfcFacturacion1', cedProfesional='cedProfesional1',
    ...
    def test(self):
        ...
        response = self.client.put('/api/preregistro/notas-observaciones/3/update/', data=json.dumps(self.json), content_type="application/json")
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        response = self.client.put('/api/preregistro/notas-observaciones/33/update/', data=json.dumps(self.json), content_type="application/json")
        print(f'response JSON ===>>> ok \n {json.dumps(response.data)} \n ---')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
