...
class GetCostoAPagar200Test(APITestCase):
    def setUp(self):
        ...
        PorExamen.objects.create(medico=medico9, estatus=3, isAprobado=False, calificacion=0, isPagado=False, isAceptado=True)
    ...
    def test(self):
        ...
        PorExamen.objects.filter(id=1).update(isAceptado=False)
        response = self.client.get('/api/recertificacion/medico/9/a-pagar/examen/')
...
class PutExamenPagado200Test(APITestCase):
    def setUp(self):
        ...
        PorExamen.objects.create(medico=medico9, estatus=1, isAprobado=False, calificacion=9)
