...
class Convocatoria(models.Model):
    ...
    banner = models.FileField(blank=True, validators=[FileExtensionValidator(allowed_extensions=['png', 'jpg', 'gif'])], upload_to='convocatoria')
...
class ConvocatoriaEnroladoDocumento(models.Model):
    ...
    documento = models.FileField(blank=True, validators=[FileExtensionValidator(allowed_extensions=['pdf', 'png', 'jpg', 'gif'])], upload_to='convocatoria')
