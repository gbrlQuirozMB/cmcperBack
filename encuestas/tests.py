...
# python manage.py test encuestas.tests.GetOpcionDetailTest
class GetOpcionDetailTest(APITestCase):
    def setUp(self):
    ...
    def test(self):
        ...
        response = self.client.get('/api/encuestas/preguntas/opciones/2/detail/')
        print(f'response JSON ===>>> ok \n {json.dumps(response.json())} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        response = self.client.get('/api/encuestas/preguntas/opciones/33/detail/')
        print(f'response JSON ===>>> ok \n {json.dumps(response.json())} \n ---')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)


# python manage.py test encuestas.tests.PutOpcionUpdateTest
class PutOpcionUpdateTest(APITestCase):
    def setUp(self):
    ...
    def test(self):
        ...
        response = self.client.put('/api/encuestas/preguntas/opciones/2/update/', data=json.dumps(self.json), content_type="application/json")
        print(f'response JSON ===>>> ok \n {json.dumps(response.json())} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)


# python manage.py test encuestas.tests.DeleteOpcionTest
class DeleteOpcionTest(APITestCase):
    def setUp(self):
    ...
    def test(self):
        ...
        response = self.client.delete('/api/encuestas/preguntas/opciones/2/delete/')
        print(f'response JSON ===>>> ok 204 sin contenido \n {response.content} \n ---')
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)

        response = self.client.delete('/api/encuestas/preguntas/opciones/22/delete/')
        print(f'response JSON ===>>> ok 204 sin contenido \n {response.content} \n ---')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
...
#  python manage.py test encuestas.tests.PostRespuestaTest
class PostRespuestaTest(APITestCase):
    def setUp(self):
        ...
        self.json = {
            "opcion": 1,
            "medico": 1,
            "fecha": (date.today() + relativedelta(days=0)).strftime('%Y-%m-%d'),
            "otro": "otro respuestas",
            "encuesta": 1,
            "pregunta": 1
...
# python manage.py test encuestas.tests.GetRespuestaDetailTest
class GetRespuestaDetailTest(APITestCase):
    def setUp(self):
    ...
    def test(self):
        ...
        response = self.client.get('/api/encuestas/respuestas/3/detail/')
        print(f'response JSON ===>>> ok \n {json.dumps(response.json())} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
# python manage.py test encuestas.tests.PutRespuestaUpdateTest
class PutRespuestaUpdateTest(APITestCase):
    def setUp(self):
    ...
    def test(self):
        ...
        response = self.client.put('/api/encuestas/respuestas/2/update/', data=json.dumps(self.json), content_type="application/json")
        print(f'response JSON ===>>> ok \n {json.dumps(response.json())} \n ---')
        self.assertEqual(response.status_code, status.HTTP_200_OK)


# python manage.py test encuestas.tests.DeleteRespuestaTest
class DeleteRespuestaTest(APITestCase):
    def setUp(self):
    ...
    def test(self):
        ...
        response = self.client.delete('/api/encuestas/respuestas/3/delete/')
        print(f'response JSON ===>>> ok 204 sin contenido \n {response.content} \n ---')
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)

        response = self.client.delete('/api/encuestas/respuestas/33/delete/')
        print(f'response JSON ===>>> ok 204 sin contenido \n {response.content} \n ---')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
